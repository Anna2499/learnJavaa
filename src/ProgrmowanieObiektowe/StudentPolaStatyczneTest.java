...
public class StudentPolaStatyczneTest {

    public static void main(String[] args) {

        String uczelnia = StudentPolaStatyczne.nazwaUczelni;

        StudentPolaStatyczne ania = new StudentPolaStatyczne();
        ania.imie = "Ania";
        ania.nazwisko = "Czek";
        ania.nick = "AniaC";
        ania.numerIndeksu = 11111;
        ania.email = "aniac@gmail.com";
        //String uczelniaAni = ania.nazwaUczelni;

        StudentPolaStatyczne piotr = new StudentPolaStatyczne();
        piotr.imie = "Piotr";
        ...
        StudentPolaStatyczne lena = new StudentPolaStatyczne();
        lena.imie = "Lena";
        ...
        StudentPolaStatyczne[] students = new StudentPolaStatyczne[3];
        students[0] = ania;
        students[1] = piotr;
        students[2] = lena;
